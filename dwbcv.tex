...
\emph{Facilitator}  \hfill {August 2014}
...
locations within the filament, under the supervision of \href{}{Professor David Lacoste}.
...
\begin{innerlist}
\item Tutored undergraduate physics students from the Five Colleges [LINK] in mathematics and physics, with a focus on classical mechanics and introductory and intermediate electromagnetism coursework.  
\item Worked on an array of research projects (described below), primarily in the areas of soft matter and statistical physics, pursuit of a doctoral degree in physics (pending).
\end{innerlist}  
...
\href{LINK}{\textbf{PLACE}}\\
\emph{TITLE} \hfill {DATES}
